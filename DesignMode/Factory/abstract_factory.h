...
public:
    void Use() override { std::cout << "Use ProductA1" << std::endl; }
};

class ProductA2 : public AbstractProductA {
public:
    void Use() override { std::cout << "Use ProductA2" << std::endl; }
};
// ProductB
...
public:
    void Use() override { std::cout << "Use ProductB1" << std::endl; }
};

class ProductB2 : public AbstractProductB {
public:
    void Use() override { std::cout << "Use ProductB2" << std::endl; }
};
// AbstractFactory
